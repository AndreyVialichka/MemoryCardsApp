...
export default function AddPackModal() {
  ...
  return (
    <div className={s.AddPackModal}>
      <Button aria-label="create" variant='contained'  onClick={handleEditModalOpen}  >
                    ADD PACK
       </Button>
      ...
      >
        ...
        <Box sx={{display:'flex', flexDirection:'column',gap:'40px', alignContent:"center", justifyContent:"center"}}>
          ...
          <Box sx={{display:'flex', justifyContent:'space-between',width:"100%"}}>
            <Button variant="contained" disabled={packName.length === 0} onClick={() => {
                addPackHandler()
